    ...
    <div className="flex items-center justify-center min-h-screen bg-bg text-textMain font-sans px-3 py-4 sm:px-4 sm:py-6">
      ...
      >
        ...
        <div className="text-center mb-6 sm:mb-8">
          <img src="/logo.png" alt="Logo" className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl object-contain mx-auto mb-3 sm:mb-4" />
        ...
        <div className="space-y-4 sm:space-y-5 mb-6 sm:mb-8">
          ...
          />
          <div>
            <label className="flex text-textSoft text-xs sm:text-sm font-semibold mb-2 justify-between items-center gap-2">
              Contraseña
              <button
                type="button"
                onClick={() => {
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-gradient-to-br from-primary to-purple-500 hover:to-purple-600 rounded-xl px-4 sm:px-5 py-2.5 sm:py-3 text-white font-bold text-sm sm:text-[15px] shadow-lg hover:shadow-primary/30 transition-all flex items-center justify-center disabled:opacity-50"
        >
          {loading ? (
            <>
        ...
        <div className="mt-4 sm:mt-5">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 border border-borderNormal rounded-xl px-4 sm:px-5 py-2.5 sm:py-3 text-textMain text-xs sm:text-sm font-semibold hover:bg-white/5 transition-all disabled:opacity-50"
          >
        ...
        <div className="mt-4 sm:mt-6 text-center border-t border-borderNormal/50 pt-4 sm:pt-6">
