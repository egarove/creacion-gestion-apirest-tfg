...
export default function LoginScreen() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      console.log("Datos de usuario obtenidos:", userData, "para email:", fbUser.uid, fbUser.email);
      ...
      if (userData == null) {
        ...
        const saved = await firebaseServiceUser.saveUser(fbUser.uid, firebaseData);
        if (saved) {
          userData = { uid: fbUser.uid, role: "usuario", apis: [], email: fbUser.email ?? undefined };
        }
      }
